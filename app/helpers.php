...
function download_types()
{
	return
	collect([
		collect(['id'=>1,'name'=>'سامسونگ MAGICIAN']),
		collect(['id'=>2,'name'=>'انتقال اطلاعات']),
		collect(['id'=>3,'name'=>'FIRMWARE']),
		collect(['id'=>4,'name'=>'درایور']),
		collect(['id'=>5,'name'=>'کیت ابزار DC']),
		collect(['id'=>6,'name'=>'نرم افزار SSD های قابل حمل']),
	]);
}



function order_state_types()
{
	$colect=collect([
		collect(['id'=>'1','name'=>'معلق']),
		collect(['id'=>'2','name'=>'اماده ارسال']),
		collect(['id'=>'3','name'=>'استرداد'])
...
function order_state_colors()
{
	$colect=collect([
		collect(['value'=>'','name'=>'سفید']),
		collect(['value'=>'success','name'=>'سبز']),
		collect(['value'=>'warning','name'=>'نارنجی']),
		collect(['value'=>'active','name'=>'خاکستری']),
		collect(['value'=>'danger','name'=>'قرمز']),
		collect(['value'=>'info','name'=>'ابی']),
...
{
	$list=['','متن','متن و عکس(متن راست)','متن و عکس(متن چپ)','متن و ویدو(متن راست)',
		'متن و ویدو(متن چپ)','عکس تکی','عکس با عنوان','ویدیو تکی','ویدیو دوتایی','اطلاعات کالا','اطلاعات کامل متن','اطلاعات کامل عکس'];
