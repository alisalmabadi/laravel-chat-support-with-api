...
--}}
                    ...
                    <span class="direct-chat-name pull-left">
                        Customer
                                        ...
                                        <!-- /.direct-chat-info -->
                                        <img class="direct-chat-img" src="{{asset('images/avatar.png')}}" alt="Message User Image"><!-- /.direct-chat-img -->
                                        <div class="direct-chat-text">
                                            {{$messages->text}}
                                        </div>
                                        <!-- /.direct-chat-text -->
  ...
  /*  $(document).ready(function()
    ...
    function sendMessage()
    {
        ...
        if (text.length > 0)
        {
            ...
            {
                $('.direct-chat-messages').append('<div class="direct-chat-msg right"><div class="direct-chat-info clearfix"><span class="direct-chat-name pull-right">{{\Auth::user()->name}}</span> <span class="direct-chat-timestamp pull-left">2018-08-25 16:59:47</span></div>  <img src="https://www.gravatar.com/avatar/ba0a1872d4ea059206ceaff12ece3841.jpg?s=80&amp;d=mm&amp;r=g" alt="Message User Image" class="direct-chat-img"> <div class="direct-chat-text">'+text+' </div> </div>');
                $('.message').val('');
            });
        }
    }*/
