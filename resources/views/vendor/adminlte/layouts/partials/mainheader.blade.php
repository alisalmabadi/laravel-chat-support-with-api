...
--}}
                @if (!Auth::check())
                    <li><a href="{{ url('operator/register') }}">{{ trans('adminlte_lang::message.register') }}</a></li>
                    <li><a href="{{ url('operator/login') }}">{{ trans('adminlte_lang::message.login') }}</a></li>
                @else
                    <!-- User Account Menu -->
                            ...
                            <li class="user-footer">
                             ...
                             {{--       <a href="{{route('logout')}}" class="btn btn-default btn-flat">
                                    ...
                                    <form id="logout-form" action="{{ url('/operator/logout') }}" method="POST" {{--style="display: none;"--}}>
                                        {{ csrf_field() }}
                                        <button type="submit" class="btn btn-default btn-flat" value="logout" {{--style="display: none;"--}}>
                                            {{ trans('adminlte_lang::message.signout') }}
                                        </button>
                                    </form>
