...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-lg"><b>Managing </b>System </span>
    </a>
...
--}}
                @if (!Auth::guard('company'))
                    <li><a href="{{ url('Company/register') }}">{{ trans('adminlte_lang::message.register') }}</a></li>
                    <li><a href="{{ url('company/login') }}">{{ trans('adminlte_lang::message.login') }}</a></li>
                @else
                    <!-- User Account Menu -->
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{ Gravatar::get(Auth::guard('company')->user()->email) }}" class="user-image" alt="User Image"/>
                            <!-- hidden-xs hides the username on small devices so only the image appears. -->
                            <span class="hidden-xs">{{Auth::guard('company')->user()->name}}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- The user image in the menu -->
                            <li class="user-header">
                                <img src="{{ Gravatar::get(Auth::guard('company')->user()->email) }}" class="img-circle" alt="User Image" />
                                <p>
                           ...
                           {{-- <li class="user-body">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    {{ csrf_field() }}
                                    <a href="{{url('/company/logout')}}" class="btn btn-default btn-flat">
