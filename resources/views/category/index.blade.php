...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-2">
            ...
            <section class="p-category-main-box-f" style="height: 500px">
            ...
            <div id="accordion" class="panel panel-primary behclick-panel">
                ...
                <div class="panel-body" >
                    <form id="frm_filter"  action="{{route('category.show_f',$category)}}" method="post" class="js-news-form">
                        {{csrf_field()}}
        ...
        <div class="col-sm-10 ">
            <section class=" p-category-main-box">
                ...
                <div class="row p-category-main-top-title" ><h4 >{{$category->name}} <span>({{count($category->products)}})</span> </h4>
                    <div  style="width: 480px; display: inline-block; padding: 0px 10px;border-right:1px solid #cbcbcb;margin: 10px 7px;float: right; ">
                    <div class="input-group" >

                        <input class="form-control" placeholder="جستوجو" name="searchh" type="text" style="height: 36px;">
